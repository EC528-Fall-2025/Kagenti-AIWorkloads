...
The generic agent is able to connect to multiple MCP servers, and is general enough to be able to use them.
...
The image agent is the only multimodal demo agent Kagenti currently has, it returns a randomly generated image of a specified size as generated by [Lorem Picsum](https://picsum.photos/).
